...
const Projects = [
    {
      ...
      desc: 'This was originally a WordPress Site that I recreated with React.js to give me the freedom to design it the way my client wanted.'
    },
    {
      title: 'Mine Sweeper', 
      ...
      desc: 'Mine Sweeper is a classic game that I recreated with JavaScript using an Api to keep track of the game state.'
    },
    {
      title: 'Movie Api',
